...
var dataMap: Record<string, any> = {};
function dataFormatter(obj: Record<string, any>) {
  // prettier-ignore
        ...
        baseOption={{
          ...
          grid: {
            ...
            tooltip: {
              ...
              axisPointer: {
                type: 'shadow',
                label: { show: true, formatter: (params: any) => params.value.replace('\n', '') },
              },
            },
          },
          xAxis: [
          ...
          timeline={{
            ...
            data: [
              ...
              '2004-01-01',
              {
                ...
                symbol: 'diamond',
                symbolSize: 16,
              } as unknown as TimelineDataItemOption,
              '2006-01-01',
              '2007-01-01',
              '2008-01-01',
              '2009-01-01',
              ...
              {
                value: '2011-01-01',
                tooltip: { formatter: (params: any) => params.name + 'GDP达到又一个高度' },
                symbol: 'diamond',
                symbolSize: 18,
              } as unknown as TimelineDataItemOption,
            ],
            label: { formatter: (s: any) => new Date(s).getFullYear() } as any,
          }}
        />
      </BarChart>
    );
