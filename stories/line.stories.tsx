...
export const AreaStackGradient: Story = {
...
export const DataTransformFilter: Story = {
...
export const LineSections: Story = {
...
export const AreaSimple: Story = {
  name: 'Large Scale Area Chart',
  render() {
...
export const MultipleXAxis: Story = {
...
export const AreaTimeAxis: Story = {
  name: 'Area Chart with Time Axis',
  render() {
...
export const DynamicData2: Story = {
  name: 'Dynamic Data + Time Axis',
  render() {
...
export const LineFunction: Story = {
  name: 'Function Plot',
  render() {
...
export const LineStyle: Story = {
  name: 'Line Style and Item Style',
  render() {
    return (
      <LineChart
        style={{ width: 480, height: 300 }}
...
export const LineInCartesianCoordinateSystem: Story = {
...
export const LineEasing: Story = {
  name: 'Line Easing Visualizing',
  render() {
    const easingFuncs = {
...
export const LineFisheyeLens: Story = {
  name: 'Fisheye Lens on Line Chart',
  render() {
    var GRID_TOP = 120;
    var GRID_BOTTOM = 80;
    var GRID_LEFT = 60;
...
export const LineYCategory: Story = {
  name: 'Line Y Category',
  render() {
    return (
      <LineChart
        style={{ width: 480, height: 300 }}
...
export const LineGraphic: Story = {
  name: 'Custom Graphic Component',
  render() {
    return (
      <LineChart
        style={{ width: 480, height: 300 }}
...
export const LinePolar: Story = {
  name: 'Two Value-Axes in Polar',
  render() {
    const data = [];
    for (let i = 0; i <= 100; i++) {
      let theta = (i / 100) * 360;
...
export const LineTooltipTouch: Story = {
  name: 'Tooltip and DataZoom on Mobile',
  render() {
...
export const LineDraggable: Story = {
...
export const IntradayBreaks1: Story = {
  name: 'Intraday Chart with Breaks',
  render() {
...
export const MatrixSparkline: Story = {
  name: 'Mini Line Charts (Sparkline) in Matrix',
  render() {
