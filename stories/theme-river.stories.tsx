import { Legend, SingleAxis, ThemeRiverChart, Tooltip } from '@fanciers/echarts-react';
...
export const BasicThemeRiver: Story = {
  name: 'ThemeRiver',
  render() {
    return (
      <ThemeRiverChart
      ...
      >
        ...
        />
        <Legend legend={{ data: ['DQ', 'TY', 'SS', 'QG', 'SY', 'DD'], top: 15 }} />
        <SingleAxis
          singleAxis={{
            top: 50,
            bottom: 50,
...
export const ThemeRiverLastfm: Story = {
  name: 'ThemeRiver Lastfm',
  render() {
    let rawData = [
    ...
    let labels = [
      ...
      'Rachael Yamagata',
      'Norah Jones',
      'Béla Fleck Fleck and the Flecktones',
      'Joshua Redman',
    ];

    let data: NonNullable<ThemeRiverSeriesOption['data']> = [];
    ...
    return (
      ...
      >
        <SingleAxis singleAxis={{ max: 'dataMax' }} />
      </ThemeRiverChart>
    );
  },
};
