import { echarts, Legend, Radar, RadarChart, Title, Tooltip, VisualMap } from '@fanciers/echarts-react';
...
export const BasicRadar: Story = {
  ...
  render() {
    return (
      ...
      >
        <Title title={{ text: 'Basic Radar Chart' }} />
        <Legend legend={{ data: ['Allocated Budget', 'Actual Spending'] }} />
        <Radar
          radar={{
            indicator: [
              { name: 'Sales', max: 6500 },
...
export const RadarAQI: Story = {
  name: 'AQI - Radar Chart',
  render() {
    const dataBJ = [
      [55, 9, 56, 0.46, 18, 6, 1],
    ...
    return (
      ...
      >
        <Title title={{ text: 'AQI - Radar', left: 'center', textStyle: { color: '#eee' } }} />
        <Legend
          legend={{
            bottom: 5,
...
export const RadarCustom: Story = {
  ...
  render() {
    return (
        ...
        series={[
          {
            ...
            data: [
              ...
              { value: [60, 5, 0.3, -100, 1500], name: 'Data B', areaStyle: { color: 'rgba(255, 228, 52, 0.6)' } },
            ],
          },
          {
            type: 'radar',
      ...
      >
        <Title title={{ text: 'Customized Radar Chart' }} />
        <Legend legend={{}} />
        <Radar
          radar={[
            {
...
export const Radar2: Story = {
  name: 'Proportion of Browsers',
  render() {
    return (
      <RadarChart
        style={{ width: 720, height: 500 }}
        series={Array.from({ length: 28 }, (_, i): RadarSeriesOption => {
          i = i + 1;
          return {
            type: 'radar',
            symbol: 'none',
            ...
            data: [{ value: [(40 - i) * 10, (38 - i) * 4 + 60, i * 5 + 10, i * 9, (i * i) / 2], name: i + 2000 + '' }],
          };
        })}
      >
        <Title title={{ text: 'Proportion of Browsers', subtext: 'Fake Data', top: 10, left: 10 }} />
        <Tooltip tooltip={{ trigger: 'item' }} />
        <Legend
          legend={{ type: 'scroll', bottom: 10, data: Array.from({ length: 28 }, (_, i) => i + 1 + 2000 + '') }}
        />
        <VisualMap visualMap={{ top: 'middle', right: 10, inRange: { color: ['red', 'yellow'] }, calculable: true }} />
        <Radar
          radar={{
            indicator: [
              { text: 'IE8-', max: 400 },
...
export const RadarMultiple: Story = {
  ...
  render() {
    return (
        ...
        series={[
          {
            ...
            areaStyle: {},
            data: [{ value: [60, 73, 85, 40], name: 'A Software' }],
          },
          {
            type: 'radar',
            radarIndex: 1,
      ...
      >
        <Title title={{ text: 'Multiple Radar' }} />
        <Tooltip tooltip={{ trigger: 'axis' }} />
        <Legend
          legend={{ left: 'center', data: ['A Software', 'A Phone', 'Another Phone', 'Precipitation', 'Evaporation'] }}
        />
        <Radar
          radar={[
            {
            ...
            {
              indicator: Array.from({ length: 12 }, (_, i) => ({ text: i + 1 + '月', max: 100 })),
              center: ['75%', '40%'],
              radius: 80,
            },
          ]}
